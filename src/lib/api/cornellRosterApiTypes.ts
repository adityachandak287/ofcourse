...
export type CornellApiResponse<TData> = CornellApiSuccess<TData> | CornellApiError
...
export type CornellRosterListResponse = CornellApiResponse<CornellRosterListData>
export type CornellSubjectListResponse = CornellApiResponse<CornellSubjectListData>
export type CornellClassSearchResponse = CornellApiResponse<CornellClassSearchData>
